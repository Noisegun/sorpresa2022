function Racing()
{
    return(<>
        <div style={{margin: "2em"}}>
            <h1>Plan de... ¡Locura Total!</h1>
        </div>
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
            Si no te ríes con esta locura/ida de olla total, es que definitivamente no he entendido tu tipo de humor
            ni tampoco tus gustos. Voy a intentar explicarme.

            Sé que te encantan los Range Rover. Que es tu coche favorito y encima en negro, en este color de las fotos
            que puedes ver aquí abajo. Y he pensado que podríamos alquilar uno durante un día entero, que nos demos un paseo
