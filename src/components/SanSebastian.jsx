        ...
        <div style={{margin: "2em"}}>
            ...
            <div className="mapouter">
                <div className="gmap_canvas">
                    <iframe width="470" title="San Sebastián" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=San%20Sebasti%C3%A1n&t=&z=15&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"/>
                </div>
            </div>
        </div>
