function Buitrago()
{
    return(<>
        <div style={{margin: "2em"}}>
            <h1>Plan de... ¡Buitrago de Lozoya!</h1>
        </div>
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
            No he vuelto a ir desde que planté un árbol allí en el año 2004, en el campamento del colegio de 6º de Primaria.
        </p>
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
            Fuimos de excursión al pueblo porque estaba cerca de nuestro alojamiento, en Piñuécar, a unos pocos km de allí.
        </p>
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
            Pura Sierra madrileña en uno de los mejores pueblos de la zona norte de Madrid. Ideal para hacer una escapada romántica...
        </p>
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
