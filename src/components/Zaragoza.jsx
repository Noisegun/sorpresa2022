function Zaragoza()
{
    return(<>
        <div style={{margin: "2em"}}>
            <h1>Has escogido... ¡Zaragoza!</h1>
            <h3>Durante 3 días (o 3 noches y 4 días) estaremos aquí...</h3>
            <div className="mapouter">
                <div className="gmap_canvas">
                    <iframe width="470" title="Zaragoza" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Eurostars%20Rey%20Fernando&t=&z=13&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"/>
                </div>
            </div>
        </div>
