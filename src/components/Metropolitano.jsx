function Metropolitano()
{
    return(<>
        ...
        <p style={{paddingLeft: "2em", paddingRight: "2em", textAlign: "justify", marginBottom: "2em"}}>
           ...
           pero es algo que tenía que añadir. La idea es acercarte al estadio. Que lo veas por fuera, que te hable de las placas de las leyendas
           y que notes un poco el ambiente que hay y, si te ves con ganas de verdad, por qué no, hacemos el tour por dentro y lo ves.

           Me niego a llamarle Wanda, que es sólo publicidad, por eso para mí va a ser el Metropolitano o el Nuevo Metropolitano, incluso, así que
           si quieres atreverte a conocer un poquito más de esto...
